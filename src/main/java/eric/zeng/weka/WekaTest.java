...
public class WekaTest {
    public static BufferedReader readDataFile(String filename) throws URISyntaxException {
        BufferedReader inputReader = null;

        URL url = WekaTest.class.getClassLoader().getResource(filename);

        try {
            inputReader = new BufferedReader(new FileReader(url.getFile()));
